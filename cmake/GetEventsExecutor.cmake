  ...
  if(NOT irobot_events_executor_POPULATED)
    ...
    elseif(rclcpp_VERSION_MAJOR EQUAL 28)
      ...
      if(NOT TARGET irobot_events_executor::irobot_lock_free_events_queue)
        ...
        target_include_directories(irobot_events_executor::irobot_lock_free_events_queue
          INTERFACE "${irobot_events_executor_SOURCE_DIR}/irobot_lock_free_events_queue/include")
      endif()
    else()
