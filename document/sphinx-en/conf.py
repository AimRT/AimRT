...
smv_tag_whitelist = r"^(v1\.7\.0|v1\.6\.0|v1\.5\.0|v1\.4\.0|v1\.3\.0|v1\.2\.0|v1\.1\.0|v1\.0\.0|v0\.10\.0|v0\.9\.3|v0\.8\.3)$"
...
html_context = {
    ...
    "versions": [
        ...
        {"name": "v1.5.0", "url": "./v1.5.0/"},
        {"name": "v1.6.0", "url": "./v1.6.0/"},
        {"name": "v1.7.0", "url": "./v1.7.0/"}
    ],
}
