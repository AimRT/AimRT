...
CASES = [
    'examples_cpp_ros2_rpc_single_pkg.yaml',
    'examples_cpp_ros2_rpc_sync.yaml',
    'examples_cpp_ros2_rpc_async.yaml',
    'examples_cpp_ros2_rpc_future.yaml',
    'examples_cpp_ros2_rpc_co.yaml',
    'examples_cpp_ros2_rpc_client_app.yaml',
    'examples_cpp_ros2_rpc_server_app.yaml',
]


@pytest.mark.parametrize('yaml_name', CASES)
def test_ros2_rpc_examples(yaml_name: str, aimrt_test_runner: AimRTTestRunner):
