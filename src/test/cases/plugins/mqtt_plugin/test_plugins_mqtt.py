...
CASES = [
    'examples_plugins_mqtt_plugin_ros2_chn.yaml',
    'examples_plugins_mqtt_plugin_pb_chn.yaml',
    'examples_plugins_mqtt_plugin_ros2_rpc.yaml',
    'examples_plugins_mqtt_plugin_pb_rpc.yaml',
...
def test_mqtt_plugin_examples(yaml_name: str, aimrt_test_runner: AimRTTestRunner):
